...
* Generate a substantial amount of content - approximately 5,000 to 8,000 tokens (aim for ~50-75 unique tweets) per user in order to achieve good diversity.
...
Generate approximately 5,000 to 8,000 tokens worth of content (roughly 50-75 unique posts).
